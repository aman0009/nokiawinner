...
timer = window.setInterval(showOne.bind(undefined), 150);
    ...
    var Fog = function () {
        function Fog() {
            ...
            var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                ...
                density = _ref$density === undefined ? 10 : _ref$density,
                _ref$velocity = _ref.velocity,
                velocity = _ref$velocity === undefined ? 1.5 : _ref$velocity,
        ...
        _createClass(Fog, [{
            ...
            value: function _createParticles() {
                ...
                for (var _i = 0; _i < this.particleCount; _i++) {
...
function resetSlide() {
    $(".wrapper_slide_animation svg").css("opacity", "0");

    $(".st0_triger").removeClass("st0");
    $(".st2_triger").removeClass("st2");
    $(".st3_triger").removeClass("st3");
    $(".st4_triger").removeClass("st4");
    $(".st6_triger").removeClass("st6");
    $(".st7_triger").removeClass("st7");

    $(".st0_anim3_triger").removeClass("st0_anim3");
    $(".st1_anim3_triger").removeClass("st1_anim3");
    $(".st2_anim3_triger").removeClass("st2_anim3");
    $(".st3_anim3_triger").removeClass("st3_anim3");
    $(".st4_anim3_triger").removeClass("st4_anim3");
    $(".st5_anim3_triger").removeClass("st5_anim3");
    $(".st6_anim3_triger").removeClass("st6_anim3");
    $(".st4_anim3_triger_blue").removeClass("st4_anim3_blue_overlay");
    $(".st5_anim3_triger_blue").removeClass("st5_anim3_blue_overlay");
    $(".st6_anim3_triger_blue").removeClass("st6_anim3_blue_overlay");

    $(".st9_anim2_triger").removeClass("st9_anim2");
    $(".st9_anim2_triger_reverse").removeClass("st9_anim2_reverse");
    $(".st10_anim2_triger_down").removeClass("st10_anim2_down");
    $(".st10_anim2_triger_up").removeClass("st10_anim2_up");
    $(".st11_anim2_triger").removeClass("st11_anim2");
    $(".st11_anim2_triger_blue_overlay").removeClass("st11_anim2_blue_overlay");
    $(".st12_anim2_triger").removeClass("st12_anim2");
    $(".st12_anim2_triger_blue_overlay").removeClass("st12_anim2_blue_overlay");
    $(".circle_yellow_triger").removeClass("circle_yellow");
    $(".circle_thin_triger").removeClass("circle_thin");
    $(".circle_thin_triger_blue").removeClass("circle_thin_blue");

    $("#particles_1").removeClass("animated fadeInRight");
    $("#particles_2").removeClass("animated fadeInLeft");

    $(".svg_globe_op").removeClass("svg_op_1");
    $(".svg_op").removeClass("svg_op_1");
    $("animateMotion").removeAttr( 'begin');
    $("animateMotion").removeAttr( 'dur');
};
...
$(function() {
    ...
    $('#fullpage').fullpage({
        ...
        scrollBar: true,
        rtl: true,
        responsiveHeight: 319,
        onLeave: function(index, nextIndex, direction){
            if(nextIndex == 1 || 2 || 4){
                $.fn.fullpage.setAllowScrolling(true);
            }
            if(nextIndex == 2){
                $('.svg_gold').addClass('gold_op');
            }else{
                 $('.svg_gold').removeClass('gold_op');
            }
            if(nextIndex == 3){
                ...
                if (window.matchMedia("(min-width: 1025px)").matches) {
                    ...
                    $(".section_3").on("mousewheel", function (event) {
                        event.preventDefault();
                        if((curSlide === 1 && (event.originalEvent.wheelDeltaY > 100)) || ((curSlide ===3) && ( event.originalEvent.wheelDeltaY < -100)) ){
                            $.fn.fullpage.setAllowScrolling(true);
                            console.log('true');
                        }
                        // else if(curSlide === 1 || curSlide === 2 || curSlide === 3){
                        //      $.fn.fullpage.setAllowScrolling(false);
                        // }
                        if ( event.originalEvent.wheelDeltaY > 100) {
                            $('.slider').slick('slickPrev');
                        } else if (event.originalEvent.wheelDeltaY < -100) {
                            $('.slider').slick('slickNext');
                        }
                    });
                }
                var userAgentStr =navigator.userAgent;
                if(userAgentStr.indexOf('Mobile') !== -1 || userAgentStr.indexOf('Tablet') !== -1){
                    $.fn.fullpage.setAllowScrolling(true);
                }
            }
            if(nextIndex == 3){
                $('li[data-menuanchor="3rdPage"]').addClass('active_dark');
            }else{
                $('li.active').removeClass('active_dark');
            }
            if(nextIndex == 4){
                $('li[data-menuanchor="4thpage"]').addClass('active_dark');
            }else{
                $('li.active').removeClass('active_dark');
            }
            if(nextIndex < 4){
                setTimeout(function(){ 
                    $(".close_map_view").css("left", "-100%");
                    $(".map_overlay").fadeIn();
                    $(".map_content_wrapper").css("left", "0%");
                    $(".top_controls").removeClass("fade_up");
                    if (window.matchMedia("(max-width: 769px)").matches) {
                        map.panTo(new google.maps.LatLng(46.204, 6.1565));
                    }else if (window.matchMedia("(min-width: 770px)").matches) {
                        map.panTo(new google.maps.LatLng(46.2009057, 6.15236608));
                    }
                }, 1500);
            }
            if(nextIndex == 5){
                ...
                if (window.matchMedia("(min-width: 641px)").matches) {
                    $(".top_controls").addClass("fade_up");
                }else{
                    $(".top_controls").removeClass("fade_up");
                }
                setTimeout(function(){ 
                    $('li[data-menuanchor="4thpage"]').addClass('active');
                }, 50);
            }else{
                $(".top_controls").removeClass("fade_up");
            }
...
// triger + listener on scroll
var triger = function triger(elements, offset, f) {
    elements.forEach(function (item, id) {
        if (item.getBoundingClientRect().bottom <= screen.height - offset) {
            f(item, id);
        }
    });
};
...
$(window).on("scroll", function (e) {
    triger([document.querySelector(".section_2")], -10, function (item, id) {
        $(".section_2_inner p").addClass("title_animate");
        document.querySelector("#section_2_line").classList.add("section_2_line_anim");
    });
    triger([document.querySelector(".section_3")], -10, function (item, id) {
        $(".st0_triger").addClass("st0");
        $(".st2_triger").addClass("st2");
        $(".st3_triger").addClass("st3");
        $(".st4_triger").addClass("st4");
        $(".st6_triger").addClass("st6");
        $(".st7_triger").addClass("st7");

        setTimeout(function () {
            $(".svg_globe_op").addClass("svg_op_1");
            $(".begin_globe_1").attr({ begin: "1s", dur: "2s" });
            $(".begin_globe_2").attr({ begin: "1.5s", dur: "3s" });
            $(".begin_globe_3").attr({ begin: "0.5s", dur: "2.5s" });
            $(".begin_globe_4").attr({ begin: "0s", dur: "2s" });
        }, 3000);

        $('h3').addClass('title_animate');
        $('.slide_descr p').addClass('animated fadeInUp');
        $('.slide_animation').addClass('animated fadeInUp');
        $('.slider_nav').addClass('animated fadeInUp');
    });
    triger([document.querySelector(".section_4")], -10, function (item, id) {
        $('h5').addClass('title_animate');
        $('.map_content p').addClass('animated fadeInUp');
        $('.map_content span').addClass('animated fadeInUp');
        $('.open_form').addClass('animated fadeInUp');
    });
});
///////////////////
...
var $total_number = $('#slider').children().length;
var $total_el = $('.slide-count-wrap').find('.total');
$total_el.text($total_number);
...
function setCurrentSlideNumber(currentSlide) {
    $el = $('.slide-count-wrap').find('.current');
    ...
    if (current_Slide == 1) {
        ...
        setTimeout(function(){ $(".wrapper_slide_animation svg").css("opacity", "1"); }, 500);
        $(".st0_triger").addClass("st0");
        $(".st2_triger").addClass("st2");
        $(".st3_triger").addClass("st3");
        $(".st4_triger").addClass("st4");
        ...
        $(".st0_anim3_triger").addClass("st0_anim3");
        $(".st1_anim3_triger").addClass("st1_anim3");
        $(".st2_anim3_triger").addClass("st2_anim3");
        $(".st3_anim3_triger").addClass("st3_anim3");
        $(".st4_anim3_triger").addClass("st4_anim3");
        $(".st5_anim3_triger").addClass("st5_anim3");
        $(".st6_anim3_triger").addClass("st6_anim3");
        $(".st4_anim3_triger_blue").addClass("st4_anim3_blue_overlay");
        $(".st5_anim3_triger_blue").addClass("st5_anim3_blue_overlay");
        $(".st6_anim3_triger_blue").addClass("st6_anim3_blue_overlay");

        setTimeout(function(){
            $(".svg_op").addClass("svg_op_1");
            $(".begin_1").attr({begin: "1s",dur: "2s",});
            $(".begin_2").attr({begin: "1.5s",dur: "3s",});
            $(".begin_3").attr({begin: "0.5s",dur: "2.5s",});
            $(".begin_4").attr({begin: "0s",dur: "2s",});
        }, 3000);
    }else if (current_Slide == 3) {
        resetSlide();
        setTimeout(function(){ $(".wrapper_slide_animation svg").css("opacity", "1"); }, 500);
        $(".st9_anim2_triger").addClass("st9_anim2");
        $(".st9_anim2_triger_reverse").addClass("st9_anim2_reverse");
        $(".st10_anim2_triger_down").addClass("st10_anim2_down");
        $(".st10_anim2_triger_up").addClass("st10_anim2_up");
        $(".st11_anim2_triger").addClass("st11_anim2");
        $(".st11_anim2_triger_blue_overlay").addClass("st11_anim2_blue_overlay");
        $(".st12_anim2_triger").addClass("st12_anim2");
        $(".st12_anim2_triger_blue_overlay").addClass("st12_anim2_blue_overlay");
        $(".circle_yellow_triger").addClass("circle_yellow");
        $(".circle_thin_triger").addClass("circle_thin");
        $(".circle_thin_triger_blue").addClass("circle_thin_blue");

        $("#particles_1").addClass("animated fadeInRight");
        $("#particles_2").addClass("animated fadeInLeft");
    }
}
// end slider

    if (window.matchMedia("(max-width: 640px)").matches) {
        $('.section_5').removeClass('fp-auto-height');
    }else if (window.matchMedia("(min-width: 641px)").matches) {
        $('.section_5').addClass('fp-auto-height');
    }
...
// $('.visible:not(:has("active"))').fadeOut();
$( ".btn_lang" ).on( "click", function() {
    $(this).find('li').toggleClass('visible');
    
});
$( ".btn_lang li" ).on( "click", function() {
    var classLi = $(this).attr('class');

    var slicedClass = classLi.slice(0, 2);

    //$(classLi).addClass('active');
    $( ".btn_lang li" ).each(function() {
        $(this).removeClass('active');
        if($(this).hasClass(slicedClass)){
            $(this).addClass('active');
        }
    });
});
//end lang btn
if (window.matchMedia("(min-height: 320px)").matches) {
    setTimeout(function(){$("html, body").css('overflow', 'hidden'); }, 500);
}

setTimeout(function(){
    $(".preloader").fadeOut(500);
    // $(".preloader").addClass('preloader_fade'); 
    $('h1').addClass('title_animate'); 
    $('.top_controls').addClass('animated fadeIn');
    $('.scroll_down').addClass('animated fadeIn');
    $('#scroll_down_line').addClass('scroll_down_anim');
}, 3000);


window.onload = function(){
    var wrapper_1 = document.querySelector('.section_4'),
    layerOne_1 = document.querySelector('.map_overlay');

    wrapper_1.addEventListener('mousemove',function(e){
        var pageX = e.clientX,
        pageY = e.clientY;
        layerOne_1.style.webkitTransform = 'translateX(' + pageX/200 + '%) translateY(' + pageY/100 + '%)';
        layerOne_1.style.transform = 'translateX(' + pageX/150 + '%) translateY(' + pageY/100 + '%)';
    });
}


//map
$( ".map_overlay, .open_map" ).on( "click", function() {
    $( ".map_overlay").fadeOut();
    $(".close_map_view").css("left", "60px");
    $(".map_content_wrapper").css("left", "-100%");
    $(".top_controls").addClass("fade_up");
    map.panTo(new google.maps.LatLng(46.2009057, 6.1559817)); 
    $("#dots").addClass("animated fadeOut");
    $.fn.fullpage.setAllowScrolling(false);
});
...
var checkBrowser = function checkBrowser(userAgentStr, browser) {
    ...
    var isItBrowser = version ? userAgentStr.indexOf(browser + '/' + version) !== -1 : userAgentStr.indexOf("" + browser) !== -1,
        notInclude = true;
    if (browser === 'Safari') {
        notInclude = userAgentStr.indexOf('Chrome') === -1 && userAgentStr.indexOf('Chromium') === -1 && userAgentStr.indexOf('OPR') === -1;
    } else if (browser === 'Chrome') {
        notInclude = userAgentStr.indexOf('Chromium') === -1 && userAgentStr.indexOf('OPR') === -1;
    ...
    isItBrowser = version ? userAgentStr.indexOf('OPR/' + version) !== -1 : userAgentStr.indexOf("OPR") !== -1
    }
    return isItBrowser && notInclude;
};
 var res = checkBrowser(navigator.userAgent,'Safari');
if(res){
    document.querySelector('body').classList.add('safari_anim');
}


$( ".close_map_view" ).on( "click", function() {
    $(this).css("left", "-100%");
    $(".map_overlay").fadeIn();
    $(".map_content_wrapper").css("left", "0%");
    $(".top_controls").removeClass("fade_up");
    $("#dots").removeClass("animated fadeOut");
    $("#dots").addClass("animated fadeIn");
    $.fn.fullpage.setAllowScrolling(true);
...
$( ".open_form" ).on( "click", function() {
    $(".form_contast_us_overlay").fadeIn();
    $(".form_contast_us").css("right", "0%");
});

$( ".back_from_form, .form_contast_us_overlay" ).on( "click", function() {
    $(".form_contast_us_overlay").fadeOut();
    $(".form_contast_us").css("right", "-100%");
});
////////////////////
...
$('input, textarea').focusin(function() {
    $(this).parents('.field').find('label').addClass('label_form_active');
});

$('input, textarea').focusout(function() {
    if($(this).val() == ''){
        $(this).parents('.field').find('label').removeClass('label_form_active');
    }
});
//------
//--end form
...
$(".btn_lang .active").on("click", function(e){
    e.preventDefault();   
    console.log('test');
});
...
particlesJS('particles_1', setings);
particlesJS('particles_2', setings);


var map;
function initMap() {
    map = new google.maps.Map(document.getElementById('map'), {
        center: {lat: 46.2009057, lng: 6.15236608},
...
var iconBase = 'img/map_icon.png';
var marker = new google.maps.Marker({
    position: {lat: 46.2009057, lng: 6.1559817},
    map: map,
    icon: iconBase,
    cursor: 'inherit'
});
